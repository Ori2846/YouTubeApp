...
def create_parser():
    ...
    verbosity.add_option(
        ...
        help=(
            'Field name or output templates to print to screen, optionally prefixed with when to print it, separated by a ":". '
    ...
    verbosity.add_option(
        ...
        help=(
            'Append given templates to the file. The values of WHEN and TEMPLATE are same as that of --print. '
            'FILE uses the same syntax as the output templates. This option can be used multiple times'))
    verbosity.add_option(
        '-g', '--get-url',
    ...
    verbosity.add_option(
        ...
        callback_kwargs={
            ...
            '--console-title --progress-templates "download-title:%(info.id)s-%(progress.eta)s"'))
    verbosity.add_option(
        '-v', '--verbose',
    ...
    filesystem.add_option(
        ...
        callback_kwargs={
            ...
            'default_key': 'default'
        }, help='Output filename templates; see "OUTPUT TEMPLATE" for details')
    filesystem.add_option(
    ...
    postproc.add_option(
        ...
        help=(
            ...
            'Same syntax as the output templates can be used to pass any field as arguments to the command. '
    ...
    sponsorblock.add_option(
        ...
        help=(
            'An output templates for the title of the SponsorBlock chapters created by --sponsorblock-mark. '
