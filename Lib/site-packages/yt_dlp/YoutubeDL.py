...
class YoutubeDL:
    ...
    print_to_file:     A dict with keys WHEN (same as forceprint) mapped to
                       a list of tuples with (templates, filename)
    ...
    progress_template: Dictionary of templates for progress outputs.
                       ...
                       The templates is mapped on a dictionary with keys 'progress' and 'info'
    ...
    def _parse_outtmpl(self):
        sanitize = IDENTITY
        if self.params.get('restrictfilenames'):  # Remove spaces in the default templates
    ...
    def _outtmpl_expandpath(outtmpl):
        ...
        # '%%' intact for templates dict substitution step. Working around
        # with boundary-alike separator hack.
        sep = ''.join(random.choices(ascii_letters, k=32))
        outtmpl = outtmpl.replace('%%', f'%{sep}%').replace('$$', f'${sep}$')

        # outtmpl should be expand_path'ed before templates dict substitution
    ...
    def prepare_filename(self, info_dict, dir_type='', *, outtmpl=None, warn=False):
        ...
        if warn:
            if not self.params.get('paths'):
                ...
                self.report_warning('--paths is ignored since an absolute path is given in output templates', only_once=True)
